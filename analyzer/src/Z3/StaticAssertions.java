...
public class StaticAssertions {
	...
	public Quantifier mk_par_then_sib() {
		...
		BoolExpr lhs2 = ctx.mkNot(ctx.mkEq(ctx.mkApp(objs.getfuncs("original_transaction"), o1), ctx.mkApp(objs.getfuncs("original_transaction"), o2)));
	...
	public Quantifier mk_sib_then_par() {
		...
		BoolExpr rhs2 = ctx.mkNot(ctx.mkEq(ctx.mkApp(objs.getfuncs("original_transaction"), o1), ctx.mkApp(objs.getfuncs("original_transaction"), o2)));
	...
	public Quantifier mk_sot_then_stepsib() {
		BoolExpr lhs1 = ctx.mkEq(ctx.mkApp(objs.getfuncs("original_transaction"), o1), ctx.mkApp(objs.getfuncs("original_transaction"), o2));
		BoolExpr lhs2 = ctx.mkNot(ctx.mkEq(ctx.mkApp(objs.getfuncs("parent"), o1), ctx.mkApp(objs.getfuncs("parent"), o2)));
		BoolExpr rhs = (BoolExpr) ctx.mkApp(objs.getfuncs("step_sibling"), o1, o2);
		BoolExpr body = ctx.mkImplies(ctx.mkAnd(lhs1, lhs2), rhs);
		Quantifier x = ctx.mkForall(new Expr[]{o1, o2}, body, 1, null, null, null, null);
		return x;
	}

	public Quantifier mk_stepsib_then_sot() {
		BoolExpr rhs1 = ctx.mkEq(ctx.mkApp(objs.getfuncs("original_transaction"), o1), ctx.mkApp(objs.getfuncs("original_transaction"), o2));
		BoolExpr rhs2 = ctx.mkNot(ctx.mkEq(ctx.mkApp(objs.getfuncs("parent"), o1), ctx.mkApp(objs.getfuncs("parent"), o2)));
		BoolExpr lhs = (BoolExpr) ctx.mkApp(objs.getfuncs("step_sibling"), o1, o2);
		BoolExpr body = ctx.mkImplies(lhs, ctx.mkAnd(rhs1, rhs2));
		Quantifier x = ctx.mkForall(new Expr[]{o1, o2}, body, 1, null, null, null, null);
		return x;
	}
	...
	public BoolExpr mk_sot_then_eq() {
		BoolExpr lhs1 = ctx.mkEq(ctx.mkApp(objs.getfuncs("original_transaction"), o1), ctx.mkApp(objs.getfuncs("original_transaction"), o2));
		BoolExpr lhs2 = ctx.mkEq(ctx.mkApp(objs.getfuncs("otype"), o1), ctx.mkApp(objs.getfuncs("otype"), o2));
		BoolExpr rhs = (BoolExpr) ctx.mkEq(o1, o2);
		BoolExpr body = ctx.mkImplies(ctx.mkAnd(lhs1, lhs2), rhs);
	...
	public BoolExpr mk_total_ar() {
		...
		BoolExpr lhs5 = ctx.mkNot((BoolExpr) ctx.mkApp(objs.getfuncs("step_sibling"), o1, o2));
		BoolExpr rhs1 = (BoolExpr) ctx.mkApp(objs.getfuncs("ar"), o1, o2);
		BoolExpr rhs2 = (BoolExpr) ctx.mkApp(objs.getfuncs("ar"), o2, o1);
		BoolExpr body = ctx.mkImplies(ctx.mkAnd(lhs1, lhs2, lhs3, lhs4, lhs5), ctx.mkXor(rhs1, rhs2));
		Quantifier x = ctx.mkForall(new Expr[]{o1, o2}, body, 1, null, null, null, null);
		return x;
	}
...
/*	public BoolExpr mk_causal_cons() {
	...
	public BoolExpr mk_read_comm() {
		BoolExpr lhs11 = ctx.mkEq(ctx.mkApp(objs.getfuncs("mtype"), o1), ctx.mkApp(objs.getfuncs("mtype"), o2));
		BoolExpr lhs12 = ctx.mkEq(ctx.mkApp(objs.getfuncs("mtype"), o2), ctx.mkApp(objs.getfuncs("mtype"), o3));
		BoolExpr lhs2 = (BoolExpr) ctx.mkApp(objs.getfuncs("sibling"), o1, o2);
		BoolExpr lhs3 = (BoolExpr) ctx.mkApp(objs.getfuncs("vis"), o1, o3);
		BoolExpr lhs = (BoolExpr) ctx.mkAnd(lhs11, lhs12, lhs2, lhs3);
	...
	public BoolExpr mk_rep_read() {
		...
		BoolExpr lhs12 = ctx.mkEq(ctx.mkApp(objs.getfuncs("mtype"), o2), ctx.mkApp(objs.getfuncs("mtype"), o3));
		BoolExpr lhs2 = (BoolExpr) ctx.mkApp(objs.getfuncs("sibling"), o1, o2);
		BoolExpr lhs3 = (BoolExpr) ctx.mkApp(objs.getfuncs("vis"), o3, o1);
		BoolExpr lhs = (BoolExpr) ctx.mkAnd(lhs11, lhs12, lhs2, lhs3);
	...
	/*public BoolExpr mk_linearizable() {
		BoolExpr lhs1 = ctx.mkEq(ctx.mkApp(objs.getfuncs("mtype"), o1), ctx.mkApp(objs.getfuncs("mtype"), o2));
		BoolExpr lhs2 = (BoolExpr) ctx.mkApp(objs.getfuncs("ar"), o1, o2);
	...
	public Quantifier mk_gen_dep() {
		...
		BoolExpr rhs1 = ctx.mkNot(ctx.mkOr((BoolExpr) ctx.mkApp(objs.getfuncs("sibling"), o1, o2),
				(BoolExpr) ctx.mkApp(objs.getfuncs("step_sibling"), o1, o2)));
	...
	public Quantifier mk_gen_depx() {
		...
		BoolExpr rhs3 = (BoolExpr) ctx.mkApp(objs.getfuncs("step_sibling"), o1, o2);
		BoolExpr body = ctx.mkImplies(lhs, ctx.mkOr(rhs1, rhs2, rhs3));
		Quantifier x = ctx.mkForall(new Expr[]{o1, o2}, body, 1, null, null, null, null);
		return x;
	}
