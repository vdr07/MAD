package benchmarks.monolith_test_case_b;
...
public class monolith_test_case_b {
	private Connection connect = null;
	private int _ISOLATION = Connection.TRANSACTION_READ_COMMITTED;
	private int id;
	Properties p;

	public monolith_test_case_b(int id) {
		this.id = id;
		p = new Properties();
	...
	public void AtualizarPopularidadeProduto1() throws SQLException {
	...
	@ChoppedTransaction(microservice="m1")
	public void AtualizarPrecoProduto2() throws SQLException {
