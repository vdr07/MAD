...
./mad.sh --analyze jpabook > results/jpabook_mono
...
./mad.sh --analyze jpabook > results/jpabook_best
...
./mad.sh --analyze jpabook > results/jpabook_full
...
./mad.sh --analyze petclinic > results/petclinic_mono
...
./mad.sh --analyze petclinic > results/petclinic_best
...
./mad.sh --analyze petclinic > results/petclinic_full
...
./mad.sh --analyze myweb > results/myweb_mono
...
./mad.sh --analyze myweb > results/myweb_full
...
./mad.sh --analyze spring_mvc_react > results/spring_mvc_react_mono
...
./mad.sh --analyze spring_mvc_react > results/spring_mvc_react_best
...
./mad.sh --analyze spring_mvc_react > results/spring_mvc_react_full
